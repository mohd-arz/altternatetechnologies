                ...
                <div class="card-body">
                    <form action="{{route('product.update',$product->id)}}" method="POST"
                        ...
                        <div class="row">
                          ...
                          <input class="form-check-input" type="checkbox" name="is_home" {{$product->is_home ? 'checked':''}} id="flexCheckDefault">
                        ...
                        <div class="row">
                          <div class="col-4">
                              <label for="title">Image 1<b class="text-danger">*</b><small>(Max 2MB)</small> </label>
                          ...
                          <div class="col-4">
                            <label for="title">Image 2<b class="text-danger">*</b><small>(Max 2MB)</small> </label>
                          ...
                          <div class="col-4">
                            <label for="title">Image 3<b class="text-danger">*</b><small>(Max 2MB)</small> </label>
