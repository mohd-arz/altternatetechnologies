                ...
                <div class="card-body">
                    <form action="{{route('clients.store')}}" method="POST"
                        ...
                        <div class="row">
                          ...
                          <div class="col-4">
                              <label for="title">File <small>(Max 2MB)</small> </label>
                                <input type="file" name="file" accept="Image/*" class="form-control-file" id="img-file" required data-parsley-required-message="Image is required">
                        ...
                        <button type="submit" id="submitbtn" class="btn btn-primary mt-2" style="min-width:85px">
                            ...
                            <span id="btn-text">Create Client</span>
                        </button>
