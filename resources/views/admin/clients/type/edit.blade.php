...
@section('title', 'Edit Clients Types') 
@section('css')
@endsection 
@section('content')
    ...
    <div class="side-app">
        <div class="main-container container-fluid">
            <div class="page-header">
                <h1 class="page-title">Edit Type</h1>
                <div>
                    <ol class="breadcrumb">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{route('clients.type.update',$type->id)}}" method="POST"
                        ...
                        <button type="submit" id="submitbtn" class="btn btn-primary mt-2" style="min-width:85px">
                            ...
                            <span id="btn-text">Edit Type</span>
                        </button>
