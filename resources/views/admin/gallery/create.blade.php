            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{route('gallery.store')}}" method="POST"
                        id="gallery-form" data-parsley-validate="true" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                          <div class="col-4">
                        ...
                        <div class="row" id="toggle-container">
                            <div class="col-4 my-4">
                                <label class="custom-switch form-switch mb-0">
                                  <input type="checkbox" name="is_home" class="custom-switch-input">
                                  <span class="custom-switch-indicator custom-switch-indicator-md"></span>
                                  <span class="custom-switch-description">Home</span>
                              </label>
                            </div>
                        </div>
...
<script>
    ...
    // })
        ...
        $("#gallery-form").submit(function(e) {
            $("#gallery-form").parsley().validate();
            if (!$("#gallery-form").parsley().isValid()) {
                return false;
            }
            e.preventDefault();
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    if (response.status) {
                        ...
                        setTimeout(() => {
                            window.location.href = "{{route('gallery_.view')}}"
                        }, 1000);
                    } else {
                        toastr.options.positionClass = "toast-top-right";
