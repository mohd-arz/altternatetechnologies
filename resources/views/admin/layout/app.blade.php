                    ...
                    <div class="main-sidemenu">
                        ...
                        <ul class="side-menu">
                                        ...
                                        <li class="panel sidetab-menu">
                                            <div class="panel-body tabs-menu-body p-0 border-0">
                                                <div class="tab-content">
                                                    <div class="tab-pane active" id="side9">
                                                        <ul class="sidemenu-list">
                                                                <li><a href="{{ ('index_dsr_reports') }}"
                                                                        class="slide-item {{ Request::is('*/dsr-reports*') ? 'active' : '' }} ">DSR
                                                                        Reports</a></li>
                                                                <li><a href="{{ ('index_daily_plan_reports') }}"
                                                                        class="slide-item {{ Request::is('*/daily-plan-report*') ? 'active' : '' }}">Daily
                                                                        Plan Reports</a></li>
                            ...
                            <li class="slide {{ Request::is('pmd/*') ? 'is-expanded' : '' }}">
                                <a class="side-menu__item" data-bs-toggle="slide" href="javascript:void(0)"><i
                                        class="side-menu__icon fe fe-layers"></i><span
                                        class="side-menu__label">PMD</span><i class="angle fe fe-chevron-right"></i>
                                </a>
                                <ul class="slide-menu">
                                    <li class="panel sidetab-menu">
                                        <ul class="sidemenu-list">
                                                <li
                                                    class="sub-slide {{ Request::is('*/approval/*') ? 'is-expanded' : '' }}">
                                                    <a class="sub-side-menu__item" data-bs-toggle="sub-slide"
                                                        href="javascript:void(0)"><span
                                                            class="sub-side-menu__label">Approval</span><i
                                                            class="sub-angle fe fe-chevron-right"></i></a>
                                                    <ul class="sub-slide-menu">
                                                            <li><a href="{{ ('pmd_approval_work_order') }}"
                                                                    class="sub-slide-item {{ Request::is('*approval/work-order') ? 'active' : '' }}">
                                                                    Work Order</a></li>
                                                            <li><a href="{{ ('approval.subbill.index') }}"
                                                                    class="sub-slide-item {{ Request::is('*approval/sub-bill') ? 'active' : '' }}">
                                                                    Sub Bill</a></li>
                                                    </ul>
                                                </li>
                                            ...
                                            <li><a href="{{ ('dlr.index') }}"
                                                    class="slide-item {{ Request::is('*/dlr*') ? 'active' : '' }}">DLR
                                                    Submit</a></li>
                                            <li><a href="{{ ('dwp.index') }}"
                                                    class="slide-item {{ Request::is('*/daily-work-plan*') ? 'active' : '' }}">Daily
                                                    Work Plan</a></li>
                                            {{-- @endif --}}

                                                <li><a href="{{ ('index_dsr') }}"
                                                        class="slide-item {{ Request::is('*/dsr*') ? 'active' : '' }}">DSR</a>
                                                </li>

                                                <li><a href="{{ ('index_boq') }}"
                                                        class="slide-item {{ Request::is('*/boq') ? 'active' : '' }}">BOQ</a>
                                                </li>

                                            <li><a href="{{ ('index_boq_sub') }}"
                                                    class="slide-item {{ Request::is('*/boq-sub*') ? 'active' : '' }}">BOQ
                                                    Sub</a></li>


                                                <li><a href="{{ ('index_monthly_planner') }}"
                                                        class="slide-item {{ Request::is('*/monthly-planner*') ? 'active' : '' }}">Monthly
                                                        Planner</a></li>
                                        </ul>
                                    </li>
                                </ul>
